...
# Replace LOKI_IP placeholder with the actual IP address
export LOKI_IP="{{ loki_private_ip }}"
envsubst < /etc/loki/loki-config-template.yaml > /etc/loki/loki-config.yaml
